...
Using given below credentials, one can post blog using local server, email me at <zakirhussainchandio99@gmail.com> to get list of users of live server.

```php
    $users = array(
        array("user" => "user1@blog.com", "pass" => "pass1", "name" => "Johnny"),
        array("user" => "user2@blog.com", "pass" => "pass2", "name" => "Being"),
        array("user" => "user3@blog.com", "pass" => "pass3", "name" => "Porter"),
    );
```

## How to setup and run the code

Clone this repo using `git clone https://github.com/Zakir118/web-engineering-assignment-1/edit/main/README.md` in htdoc. There is a file [dbSetup.php](dbSetup.php) in root directory, which will generate a dummy database with some record to test the blog side of application. Run it on localhost using [http://localhost/todo&blog-app/dbSetup.php](http://localhost/todo&blog-app/dbSetup.php) url.
